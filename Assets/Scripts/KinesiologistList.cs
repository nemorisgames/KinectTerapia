...
public class KinesiologistList : MonoBehaviour {
    public GameObject Kinesiologist;
    ...
    void Start () {
        ...
        TableKinesiologist[] tablePatients = DatabaseManager.instance.GetKinesiologists();
        int cont = 0;
        foreach(TableKinesiologist t in tablePatients)
        {
            GameObject g = (GameObject)Instantiate(Kinesiologist);
            ...
            p.SetInformation(t.pk_kinesiologist, t.name);
